You have been tasked with deploying a small, containerized web application in a production like AWS environment using best practices for automation, security and observability.
